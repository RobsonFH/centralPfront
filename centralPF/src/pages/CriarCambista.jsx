...
function CriarCambista() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Lógica para salvar os dados do cambista
    console.log('Dados do cambista:', formData);
  };

  return (
    <div>
      <h2>Criar Novo Cambista</h2>
